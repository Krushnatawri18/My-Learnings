...
function showUsers(users) {
  users.forEach(function (user) {
    ...
    blurredImage.style.backgroundImage = `url(${user.pic})`;
    blurredImage.classList.add('blurred-layer');
...
input.addEventListener('input', function () {
    ...
    // remove all cards else new cards will be added on every search
